...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        // Example 3: [1,2,3,4,5,null,null] -> [4,5,2,3,1]
        check("example: [1,2,3,4,5,null,null]",
                new Integer[]{1, 2, 3, 4, 5, null, null}, list(4, 5, 2, 3, 1));
        ...
        // Zigzag [1,2,null,null,3,4]: 1.left=2;2.right=3;3.left=4 -> [4,3,2,1]
        check("zigzag [1,2,null,null,3,4]", new Integer[]{1, 2, null, null, 3, 4},
                list(4, 3, 2, 1));
        // Root right subtree [1,null,2,3,4]: 1.right=2;2.left=3;2.right=4 -> [3,4,2,1]
        check("root right subtree [1,null,2,3,4]", new Integer[]{1, null, 2, 3, 4},
                list(3, 4, 2, 1));
        // Mixed bounds perfect tree -> [-50,50,-100,-25,25,100,0]
        check("mixed bounds [0,-100,100,-50,50,-25,25]",
                new Integer[]{0, -100, 100, -50, 50, -25, 25},
                list(-50, 50, -100, -25, 25, 100, 0));
        // Off-by-one complete tree of 6 nodes [1,2,3,4,5,6] -> [4,5,2,6,3,1]
        ...
        // Left-skewed degenerate of 100 nodes (stack-depth stress for iterative impls).
        {
            int n = 100;

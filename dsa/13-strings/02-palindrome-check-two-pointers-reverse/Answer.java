// Valid Palindrome  —  String Manipulation / Palindrome Check (Two Pointers / Reverse)
 ...
 *   From dsa/      :   bash run-tests.sh 13-strings/02-palindrome-check-two-pointers-reverse
